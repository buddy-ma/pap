<aside class="app-sidebar">
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <?php if(Auth::user()->hasAnyPermission(['product-list', 'product-create', 'product-edit', 'product-delete'])): ?>
            <li class="slide mt-3">
                <a class="side-menu__item" data-toggle="slide">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                        width="24">
        ...
        <li class="slide mt-3">
            ...
            <ul class="slide-menu">
                <li>
                    <a class="slide-item" href="<?php echo e(url('/admin/all-products')); ?>">Tous les produits</a>
                </li>
            </ul>
        </li>
...
<?php /**PATH /var/www/html/resources/views/admin/layouts/aside-menu.blade.php ENDPATH**/ ?>