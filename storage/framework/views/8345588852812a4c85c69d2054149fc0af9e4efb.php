...
<?php $__env->startSection('css'); ?>
    ...
    <style>
        ...
        .screenshot {
            background: url('<?php echo e(asset('admin_assets/images/screenshots/numbers.png')); ?>');
...
<?php $__env->startSection('page-header'); ?>
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Numbers </h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="/profile">Numbers</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="row flex-lg-nowrap">
        <div class="col-12">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin-numbers')->html();
} elseif ($_instance->childHasBeenRendered('PX51L1J')) {
    $componentId = $_instance->getRenderedChildComponentId('PX51L1J');
    $componentTag = $_instance->getRenderedChildComponentTagName('PX51L1J');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PX51L1J');
} else {
    $response = \Livewire\Livewire::mount('admin-numbers');
    $html = $response->html();
    $_instance->logRenderedChild('PX51L1J', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/admin/mains-admin/landing/numbers.blade.php ENDPATH**/ ?>