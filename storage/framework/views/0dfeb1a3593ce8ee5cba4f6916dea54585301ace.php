                        ...
                        <div class="project-inner project-head">
                            <div class="homes">
                                <a href="single-property-1.html" class="homes-img">
                                    <div class="homes-tag button alt featured"><?php echo e($product->category->title); ?></div>
                                    <?php if($product->first_image() !== null): ?>
                                        <img src="<?php echo e(URL::asset('storage/product/images/' . $product->first_image()->image)); ?>"
                                            alt="home-1" class="img-responsive">
                                    <?php else: ?>
                                        <img src="<?php echo e(URL::asset('admin_assets/images/products/1.jpg')); ?>" alt="img"
...
<?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/landing/product/similarProduits.blade.php ENDPATH**/ ?>