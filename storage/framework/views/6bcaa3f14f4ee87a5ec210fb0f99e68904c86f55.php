...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('blog-listing')->html();
} elseif ($_instance->childHasBeenRendered('GiBIKbC')) {
    $componentId = $_instance->getRenderedChildComponentId('GiBIKbC');
    $componentTag = $_instance->getRenderedChildComponentTagName('GiBIKbC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GiBIKbC');
} else {
    $response = \Livewire\Livewire::mount('blog-listing');
    $html = $response->html();
    $_instance->logRenderedChild('GiBIKbC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/admin/mains-admin/blogs/blog-list.blade.php ENDPATH**/ ?>