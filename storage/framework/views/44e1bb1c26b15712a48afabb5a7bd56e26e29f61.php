...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row flex-lg-nowrap">
        <div class="col-12">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('commercialiser-contacts-admin')->html();
} elseif ($_instance->childHasBeenRendered('ykgdAqI')) {
    $componentId = $_instance->getRenderedChildComponentId('ykgdAqI');
    $componentTag = $_instance->getRenderedChildComponentTagName('ykgdAqI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ykgdAqI');
} else {
    $response = \Livewire\Livewire::mount('commercialiser-contacts-admin');
    $html = $response->html();
    $_instance->logRenderedChild('ykgdAqI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/commercialiser/commercialiser-contacts.blade.php ENDPATH**/ ?>