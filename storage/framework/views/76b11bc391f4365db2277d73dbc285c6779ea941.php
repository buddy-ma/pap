...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row flex-lg-nowrap">
        <div class="col-12">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('design-live')->html();
} elseif ($_instance->childHasBeenRendered('xydNpjh')) {
    $componentId = $_instance->getRenderedChildComponentId('xydNpjh');
    $componentTag = $_instance->getRenderedChildComponentTagName('xydNpjh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xydNpjh');
} else {
    $response = \Livewire\Livewire::mount('design-live');
    $html = $response->html();
    $_instance->logRenderedChild('xydNpjh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/designs.blade.php ENDPATH**/ ?>