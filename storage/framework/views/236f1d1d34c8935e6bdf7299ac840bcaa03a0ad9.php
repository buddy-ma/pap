<div>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="custom-controls-stacked">
                                ...
                                <?php if(!empty($product->size_chart)): ?>
                                    <img src="<?php echo e(asset("storage/general/$product->size_chart")); ?>" alt="img"
                                        class="img-fluid" style="max-height: 100px; border 2px solid #ddd;">
                                <?php endif; ?>
                        ...
                        <table class="table table-inbox table-hover text-nowrap mb-0">
                            <tbody>
                                <tr class="">
                                    ...
                                    <td class="view-message font-weight-semibold">Edit</td>
                                    <td class="view-message font-weight-semibold">Delete</td>
                                </tr>
                                <?php if(isset($product->ProductSizes)): ?>
                                    <?php $__currentLoopData = $product->ProductSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="">
                                            ...
                                            <td class="view-message">( <?php echo e($size->detail); ?>cm )</td>
                                            <td class="view-message">
                                                <span class="badge badge-dark badge-pill"><?php echo e($size->price1); ?>dh</span>
                                            </td>
                                            <td class="view-message">
                                                <span
                                            ...
                                            <td class="view-message ">
                                                <span wire:click="editSize(<?php echo e($size->id); ?>)">
                                                    <i class="fe fe-edit"></i>
                                                </span>
                                            </td>
                                            <td class="view-message">
                                                <span wire:click="deleteSize(<?php echo e($size->id); ?>)">
                                ...
                                <?php if($add_option): ?>
                                    <tr class="bg-danger" style="cursor: pointer" wire:click="addSizes">
                                        <td colspan="8" class="text-center text-white font-weight-semibold">
                                            Close
                                        </td>
                                    </tr>
                                <?php elseif($edit_option): ?>
                                    <tr class="bg-danger" style="cursor: pointer" wire:click="closeEditSize">
                                        <td colspan="8" class="text-center text-white font-weight-semibold">
                                            Close
                                        </td>
                                    </tr>
                                <?php else: ?>
                                    <tr class="bg-dark" style="cursor: pointer" wire:click="addSizes">
                                        <td colspan="8" class="text-center text-white font-weight-semibold">Add
                                            new size</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
    ...
    <div class="row">
        <?php if(!empty($product->ProductImages)): ?>
            <?php $__currentLoopData = $product->ProductImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-3 col-6">
                    <div class="card overflow-hidden">
                        <img src="<?php echo e(asset("storage/products/$img->image")); ?>" alt="image"
                            class="card-image1 ">
                        <div class="card-body bg-danger"
                            style="cursor: pointer; padding-top: 15px; padding-bottom: 15px"
                            wire:click="deleteImage(<?php echo e($img->id); ?>)">
                            <h6 class="text-center fs-14 text-white">Delete</h6>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/livewire/admin-products.blade.php ENDPATH**/ ?>