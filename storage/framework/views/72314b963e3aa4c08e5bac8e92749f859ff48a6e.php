...
} elseif ($_instance->childHasBeenRendered('4iqJhTs')) {
    $componentId = $_instance->getRenderedChildComponentId('4iqJhTs');
    $componentTag = $_instance->getRenderedChildComponentTagName('4iqJhTs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4iqJhTs');
} else {
    $response = \Livewire\Livewire::mount('admin-email');
    $html = $response->html();
    $_instance->logRenderedChild('4iqJhTs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BUDDY\OneDrive\Desktop\soukaina-portfolio\resources\views/admin/mains-admin/landing/emails.blade.php ENDPATH**/ ?>