...
} elseif ($_instance->childHasBeenRendered('opMrpR8')) {
    $componentId = $_instance->getRenderedChildComponentId('opMrpR8');
    $componentTag = $_instance->getRenderedChildComponentTagName('opMrpR8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('opMrpR8');
} else {
    $response = \Livewire\Livewire::mount('profile');
    $html = $response->html();
    $_instance->logRenderedChild('opMrpR8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/profile.blade.php ENDPATH**/ ?>