...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row flex-lg-nowrap">
        <div class="col-12">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('settings')->html();
} elseif ($_instance->childHasBeenRendered('FgiPH1E')) {
    $componentId = $_instance->getRenderedChildComponentId('FgiPH1E');
    $componentTag = $_instance->getRenderedChildComponentTagName('FgiPH1E');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FgiPH1E');
} else {
    $response = \Livewire\Livewire::mount('settings');
    $html = $response->html();
    $_instance->logRenderedChild('FgiPH1E', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/settings.blade.php ENDPATH**/ ?>