...
} elseif ($_instance->childHasBeenRendered('jh2yi5l')) {
    $componentId = $_instance->getRenderedChildComponentId('jh2yi5l');
    $componentTag = $_instance->getRenderedChildComponentTagName('jh2yi5l');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jh2yi5l');
} else {
    $response = \Livewire\Livewire::mount('add-product');
    $html = $response->html();
    $_instance->logRenderedChild('jh2yi5l', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\le\Desktop\Projects\pap\resources\views/admin/mains-admin/products/product-add.blade.php ENDPATH**/ ?>