...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('blog-listing-decouvrez')->html();
} elseif ($_instance->childHasBeenRendered('pSHmrkV')) {
    $componentId = $_instance->getRenderedChildComponentId('pSHmrkV');
    $componentTag = $_instance->getRenderedChildComponentTagName('pSHmrkV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pSHmrkV');
} else {
    $response = \Livewire\Livewire::mount('blog-listing-decouvrez');
    $html = $response->html();
    $_instance->logRenderedChild('pSHmrkV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/admin/mains-admin/blogs/blog-decouvrez.blade.php ENDPATH**/ ?>