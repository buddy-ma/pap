<section class="blog-section bg-white-2 w-100">
    <div class="container">
        ...
        <div class="news-wrap">
            <div class="row">
                <?php $__currentLoopData = $articlesMaroc;
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $art) : $__env->incrementLoopIndices();
                            ...
                            <a href="/blog/<?php echo e($art->id); ?>" class="news-img-link">
                                <div class="news-item-img">
                                    <?php if (isset($art->image)) : ?>
                                        <img class="img-responsive" src="<?php echo e(asset('images/' . $art->image)); ?>" alt="blog image">
                                    <?php else : ?>
