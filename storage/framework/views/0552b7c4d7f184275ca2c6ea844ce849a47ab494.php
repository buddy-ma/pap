...
} elseif ($_instance->childHasBeenRendered('tu1cc0O')) {
    $componentId = $_instance->getRenderedChildComponentId('tu1cc0O');
    $componentTag = $_instance->getRenderedChildComponentTagName('tu1cc0O');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tu1cc0O');
} else {
    $response = \Livewire\Livewire::mount('admin-orders');
    $html = $response->html();
    $_instance->logRenderedChild('tu1cc0O', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/orders.blade.php ENDPATH**/ ?>