...
<head>
    ...
    <title>Buddy - <?php echo $__env->yieldContent('title'); ?></title>
...
<body data-offset="50" data-spy="scroll" data-bs-target=".navbar" class="<?php echo e(App::getLocale() == 'ar' ? "rtl" : "ltr"); ?> <?php echo $__env->yieldContent('bodyClass'); ?> ">
    <!--loader start>
    ...
    <?php else : ?>
        <?php echo $__env->make('partials.art_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
...
<?php /**PATH C:\Users\ayman\Desktop\buddy_world\buddy_world\resources\views/layouts/app.blade.php ENDPATH**/ ?>