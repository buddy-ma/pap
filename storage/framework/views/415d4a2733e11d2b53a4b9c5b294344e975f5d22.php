                    ...
                    <div>
                        <div class="form-group">
                            <form action="<?php echo e(route('save_emails')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="flex">
                                    <input class="form-control" name="email" style="border: 1px solid #000" placeholder="Please Enter Your Email Address" type="email">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/art.blade.php ENDPATH**/ ?>