...
} elseif ($_instance->childHasBeenRendered('jlTLv9S')) {
    $componentId = $_instance->getRenderedChildComponentId('jlTLv9S');
    $componentTag = $_instance->getRenderedChildComponentTagName('jlTLv9S');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jlTLv9S');
} else {
    $response = \Livewire\Livewire::mount('profile');
    $html = $response->html();
    $_instance->logRenderedChild('jlTLv9S', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/landing/profile.blade.php ENDPATH**/ ?>