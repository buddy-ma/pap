...
<section class="portfolio-section zoom-gallery">
    <div class="filter-section">
        ...
        <div class="isotopeContainer row">
            <div class="col-lg-2 col-md-4 col-sm-6 p-0 isotopeSelector shoes">
                <div class="overlay">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 p-0 isotopeSelector fashion">
                <div class="overlay">
                    <div class="border-portfolio">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 p-0 isotopeSelector watch">
                <div class="overlay">
                    <div class="border-portfolio">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 p-0 isotopeSelector bags">
                <div class="overlay">
                    <div class="border-portfolio">
    ...
    <div class="pagination_sec">
        <div class="content_detail__pagination cdp">
            <ul>
                <li><a class="prev" href="#"><i aria-hidden="true" class="fa fa-angle-double-left"></i></a>
                </li>
                <li><a class="active cdp_i" href="#">1</a></li>
                <li><a class="cdp_i" href="#">2</a></li>
                <li><a class="cdp_i" href="#">3</a></li>
                <li><a class="next" href="#"><i aria-hidden="true" class="fa fa-angle-double-right"></i></a>
                </li>
            </ul>
        </div>
    </div>
...
<!-- Section ends -->
<?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/static/portfolio1.blade.php ENDPATH**/ ?>