...
} elseif ($_instance->childHasBeenRendered('TIdx2fD')) {
    $componentId = $_instance->getRenderedChildComponentId('TIdx2fD');
    $componentTag = $_instance->getRenderedChildComponentTagName('TIdx2fD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TIdx2fD');
} else {
    $response = \Livewire\Livewire::mount('admin-header');
    $html = $response->html();
    $_instance->logRenderedChild('TIdx2fD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/header.blade.php ENDPATH**/ ?>