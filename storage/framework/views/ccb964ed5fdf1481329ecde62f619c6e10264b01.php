    ...
    <div id="header" class="head-tr bottom">
        <div class="container container-header">
            ...
            <div class="left-side">
                <!-- Logo -->
                <div id="logo">
                    <a href="index.html"><img src="<?php echo e(asset('assets/images/logo-white-1.svg')); ?>"
                            data-sticky-logo="<?php echo e(asset('assets/images/logo-purple.svg')); ?>" alt=""></a>
                </div>
                <!-- Mobile Navigation -->
            ...
            <div class="header-user-menu user-menu add">
                <div class="header-user-name">
                    <span><img src="<?php echo e(asset('assets/images/testimonials/ts-1.jpg')); ?>" alt=""></span>Hi,
                    Mary!
                </div>
                <ul>
...
<?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/partials/header.blade.php ENDPATH**/ ?>