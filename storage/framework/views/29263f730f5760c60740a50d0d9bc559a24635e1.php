...
} elseif ($_instance->childHasBeenRendered('fpBkH4u')) {
    $componentId = $_instance->getRenderedChildComponentId('fpBkH4u');
    $componentTag = $_instance->getRenderedChildComponentTagName('fpBkH4u');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fpBkH4u');
} else {
    $response = \Livewire\Livewire::mount('contact-livewire');
    $html = $response->html();
    $_instance->logRenderedChild('fpBkH4u', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </section>  
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\BUDDY\buddy_old\resources\views/home.blade.php ENDPATH**/ ?>