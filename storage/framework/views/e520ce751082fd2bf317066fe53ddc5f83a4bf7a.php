    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/admin/profile">Plans</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
} elseif ($_instance->childHasBeenRendered('8CpeVqH')) {
    $componentId = $_instance->getRenderedChildComponentId('8CpeVqH');
    $componentTag = $_instance->getRenderedChildComponentTagName('8CpeVqH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8CpeVqH');
} else {
    $response = \Livewire\Livewire::mount('admin-plans');
    $html = $response->html();
    $_instance->logRenderedChild('8CpeVqH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/plans.blade.php ENDPATH**/ ?>