...
<?php $__env->startSection('css'); ?>
    ...
    <style>
        ...
        .screenshot {
            background: url('<?php echo e(asset('admin_assets/images/screenshots/header.png')); ?>');
...
<?php $__env->startSection('page-header'); ?>
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Header </h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="/header">Header</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
} elseif ($_instance->childHasBeenRendered('MWLDbIT')) {
    $componentId = $_instance->getRenderedChildComponentId('MWLDbIT');
    $componentTag = $_instance->getRenderedChildComponentTagName('MWLDbIT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MWLDbIT');
} else {
    $response = \Livewire\Livewire::mount('admin-header');
    $html = $response->html();
    $_instance->logRenderedChild('MWLDbIT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/admin/mains-admin/landing/header.blade.php ENDPATH**/ ?>