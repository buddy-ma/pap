...
} elseif ($_instance->childHasBeenRendered('WkSGT4d')) {
    $componentId = $_instance->getRenderedChildComponentId('WkSGT4d');
    $componentTag = $_instance->getRenderedChildComponentTagName('WkSGT4d');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WkSGT4d');
} else {
    $response = \Livewire\Livewire::mount('users');
    $html = $response->html();
    $_instance->logRenderedChild('WkSGT4d', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/admin/mains-admin/user/user-list.blade.php ENDPATH**/ ?>