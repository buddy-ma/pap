...
} elseif ($_instance->childHasBeenRendered('3hi7hKl')) {
    $componentId = $_instance->getRenderedChildComponentId('3hi7hKl');
    $componentTag = $_instance->getRenderedChildComponentTagName('3hi7hKl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3hi7hKl');
} else {
    $response = \Livewire\Livewire::mount('admin-services');
    $html = $response->html();
    $_instance->logRenderedChild('3hi7hKl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/landing/services.blade.php ENDPATH**/ ?>