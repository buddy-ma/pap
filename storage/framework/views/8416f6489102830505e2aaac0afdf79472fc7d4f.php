        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if ($product->product_category_id == 3) : ?>
                    <div class="single homes-content details mb-30">
                        ...
                        <table id="customers">
                            ...
                            <?php $__currentLoopData = $product->biens;
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $k => $v) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($v->title); ?></td>
                                    <td><?php echo e($v->price); ?> dh</td>
                                    <td><?php echo e($v->surface); ?> m²</td>
                                    <td><button class="btn btn-primary" data-toggle="modal" data-target="#modal<?php echo e($k); ?>">Plan</button></td>
                                </tr>
                                <div class="modal fade" id="modal<?php echo e($k); ?>" tabindex="-1" role="dialog" aria-labelledby="modalTitle<?php echo e($k); ?>" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="<?php echo e(route('produitContact', $product->id)); ?>">
                                                    ...
                                                    <input type="text" name="fullname" placeholder="Nom complet" class="form-control mb-3" required />
                ...
                <?php if (isset($product->video_link)) : ?>
                    <div class="property-location map mt-4">
                        ...
                        <div style="position:relative;padding-top:56.25%;">
                            <iframe src="<?php echo e($product->video_link); ?>" frameborder="0" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="property-location map mt-4">
                    ...
                    <iframe src="<?php echo e($product->position); ?>" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
