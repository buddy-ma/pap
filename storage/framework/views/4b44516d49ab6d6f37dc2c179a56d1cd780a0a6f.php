...
<?php if (isset($header)) : ?>
    <?php echo $__env->make('dynamic.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php else : ?>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 text-center ">
                        <div class="portfolio_section">
                            <div>
                                <h1 class="breadcrumb-text">Welcome to soukaina's <span class="bold-text color-animated">Art.</span></h1>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="service bg-white">
                        <div class="img-block">
                            <lord-icon src="https://cdn.lordicon.com/xhbsnkyp.json" trigger="hover" colors="outline:#121331,primary:#92140c,secondary:#f9c9c0" style="width:150px;height:150px">
                            </lord-icon>
                        </div>
                        <div class="service-feature">
                            ...
                            <p>Building up a new brand involves a variety of different aspects, including new identity
                                design, logo design, business card designs and more! We can provide all of these
                                services
                ...
                <div class="col-lg-4">
                    <div class="service bg-white">
                        <div class="img-block">
                            <lord-icon src="https://cdn.lordicon.com/hqrgkqvs.json" trigger="hover" colors="outline:#121331,primary:#f28ba8,secondary:#ebe6ef" style="width:150px;height:150px">
                            </lord-icon>
                        </div>
                        <div class="service-feature">
                            <h4 class="feature-text text-center">Graphic Design</h4>
                            <p>Our prospect is to provide the best solution in the field and by finding the best
                                inspiration
                ...
                <div class="col-lg-4">
                    <div class="service bg-white">
                        <div class="img-block">
                            <lord-icon src="https://cdn.lordicon.com/alzqexpi.json" trigger="hover" colors="primary:#121331,secondary:#646e78,tertiary:#fad1e6,quaternary:#f49cc8,quinary:#ffffff" style="width:150px;height:150px">
                            </lord-icon>
                        </div>
                        <div class="service-feature">
                    ...
                    <div>
                        <div class="form-group">
                            <form action="<?php echo e(route('save_emails')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="flex">
                                    <input class="form-control" name="email" placeholder="Please Enter Your Email Address" type="email">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/art.blade.php ENDPATH**/ ?>