...
} elseif ($_instance->childHasBeenRendered('HgNT8aO')) {
    $componentId = $_instance->getRenderedChildComponentId('HgNT8aO');
    $componentTag = $_instance->getRenderedChildComponentTagName('HgNT8aO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HgNT8aO');
} else {
    $response = \Livewire\Livewire::mount('product-listing');
    $html = $response->html();
    $_instance->logRenderedChild('HgNT8aO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
