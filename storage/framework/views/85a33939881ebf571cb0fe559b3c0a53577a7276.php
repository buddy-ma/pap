...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('product-listing')->html();
} elseif ($_instance->childHasBeenRendered('MoS99Pb')) {
    $componentId = $_instance->getRenderedChildComponentId('MoS99Pb');
    $componentTag = $_instance->getRenderedChildComponentTagName('MoS99Pb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MoS99Pb');
} else {
    $response = \Livewire\Livewire::mount('product-listing');
    $html = $response->html();
    $_instance->logRenderedChild('MoS99Pb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/admin/mains-admin/products/product-list.blade.php ENDPATH**/ ?>