    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/admin/products">Products</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<div class="row flex-lg-nowrap">
    <div class="col-12">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin-products')->html();
} elseif ($_instance->childHasBeenRendered('HnAtv2K')) {
    $componentId = $_instance->getRenderedChildComponentId('HnAtv2K');
    $componentTag = $_instance->getRenderedChildComponentTagName('HnAtv2K');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HnAtv2K');
} else {
    $response = \Livewire\Livewire::mount('admin-products');
    $html = $response->html();
    $_instance->logRenderedChild('HnAtv2K', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/admin/mains-admin/landing/products.blade.php ENDPATH**/ ?>