...
<?php $__env->startSection('css'); ?>
    ...
    <style>
        ...
        .screenshot {
            background: url('<?php echo e(asset('admin_assets/images/screenshots/services.png')); ?>');
    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/profile">Services</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="row flex-lg-nowrap">
        <div class="col-12">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin-services')->html();
} elseif ($_instance->childHasBeenRendered('aXhCkSs')) {
    $componentId = $_instance->getRenderedChildComponentId('aXhCkSs');
    $componentTag = $_instance->getRenderedChildComponentTagName('aXhCkSs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aXhCkSs');
} else {
    $response = \Livewire\Livewire::mount('admin-services');
    $html = $response->html();
    $_instance->logRenderedChild('aXhCkSs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/admin/mains-admin/landing/services.blade.php ENDPATH**/ ?>