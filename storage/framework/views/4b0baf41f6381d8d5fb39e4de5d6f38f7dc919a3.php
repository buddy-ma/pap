...
} elseif ($_instance->childHasBeenRendered('xCCKXa9')) {
    $componentId = $_instance->getRenderedChildComponentId('xCCKXa9');
    $componentTag = $_instance->getRenderedChildComponentTagName('xCCKXa9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xCCKXa9');
} else {
    $response = \Livewire\Livewire::mount('admin-plans');
    $html = $response->html();
    $_instance->logRenderedChild('xCCKXa9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/landing/plans.blade.php ENDPATH**/ ?>