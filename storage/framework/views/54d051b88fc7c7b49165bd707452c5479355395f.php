            ...
            <div class="col-3">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-footer">
                        <a class="btn btn-primary" href="/admin/villes/edit/<?php echo e($ville->id); ?>"> <i class="fa fa-edit"></i>
                            Modifier</a>
                        <a class="btn btn-danger" href="/admin/villes/delete/<?php echo e($ville->id); ?>"> <i
                                class="fa fa-trash"></i>
                            Supprimer</a>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/admin/mains-admin/villes/ville-list.blade.php ENDPATH**/ ?>