...
<?php $__env->startSection('css'); ?>
    ...
    <style>
        ...
        .screenshot {
            background: url('<?php echo e(asset('admin_assets/images/screenshots/plans.png')); ?>');
    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/profile">Plans</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="row flex-lg-nowrap">
        <div class="col-12">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin-plans')->html();
} elseif ($_instance->childHasBeenRendered('ub6myg7')) {
    $componentId = $_instance->getRenderedChildComponentId('ub6myg7');
    $componentTag = $_instance->getRenderedChildComponentTagName('ub6myg7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ub6myg7');
} else {
    $response = \Livewire\Livewire::mount('admin-plans');
    $html = $response->html();
    $_instance->logRenderedChild('ub6myg7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/admin/mains-admin/landing/plans.blade.php ENDPATH**/ ?>