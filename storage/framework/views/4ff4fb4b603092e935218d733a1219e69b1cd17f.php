            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="main-profile-contact-list">
                        ...
                        <?php else: ?>
                            <p class="text-center"> There is no social links yet </p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-9 col-lg-9 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="main-profile-bio mb-0">
                            <div class="row">
                                <?php $__currentLoopData = $inputs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-6">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span style="background-color: <?php echo e($v); ?>"
                                                    class="input-group-text" id="basic-addon1">
                                                    <i class="text-white fa fa-<?php echo e($key); ?>"></i>
                                                </span>
                                            </div>
                                            <input type="text" class="form-control"
                                                placeholder="<?php echo e($key); ?>" aria-label="<?php echo e($key); ?>"
                                                aria-describedby="basic-addon1"
                                                wire:model="socials.<?php echo e($key); ?>">
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php /**PATH C:\Users\BUDDY\OneDrive\Desktop\soukaina-portfolio\resources\views/livewire/profile.blade.php ENDPATH**/ ?>