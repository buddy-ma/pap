...
} elseif ($_instance->childHasBeenRendered('rvZ1MmV')) {
    $componentId = $_instance->getRenderedChildComponentId('rvZ1MmV');
    $componentTag = $_instance->getRenderedChildComponentTagName('rvZ1MmV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rvZ1MmV');
} else {
    $response = \Livewire\Livewire::mount('admin-header');
    $html = $response->html();
    $_instance->logRenderedChild('rvZ1MmV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/landing/header.blade.php ENDPATH**/ ?>