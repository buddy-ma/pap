...
} elseif ($_instance->childHasBeenRendered('bsMmNqm')) {
    $componentId = $_instance->getRenderedChildComponentId('bsMmNqm');
    $componentTag = $_instance->getRenderedChildComponentTagName('bsMmNqm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bsMmNqm');
} else {
    $response = \Livewire\Livewire::mount('blog-categories-admin');
    $html = $response->html();
    $_instance->logRenderedChild('bsMmNqm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/categorie/categorie-list.blade.php ENDPATH**/ ?>