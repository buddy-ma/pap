                        ...
                        <ul class="timeline mb-0">
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Ella Lambert</span> ontime order
                                    delivery <a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="font-weight-semibold">Service
                                        Management</a></p>
                            </li>
                            <li>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/admin/mains-admin/statistics/dashboard.blade.php ENDPATH**/ ?>