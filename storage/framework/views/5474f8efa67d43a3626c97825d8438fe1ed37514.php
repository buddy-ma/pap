    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/admin/orders">Orders</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<div class="row flex-lg-nowrap">
    <div class="col-12">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin-orders')->html();
} elseif ($_instance->childHasBeenRendered('pdyJt3r')) {
    $componentId = $_instance->getRenderedChildComponentId('pdyJt3r');
    $componentTag = $_instance->getRenderedChildComponentTagName('pdyJt3r');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pdyJt3r');
} else {
    $response = \Livewire\Livewire::mount('admin-orders');
    $html = $response->html();
    $_instance->logRenderedChild('pdyJt3r', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/admin/mains-admin/landing/orders.blade.php ENDPATH**/ ?>