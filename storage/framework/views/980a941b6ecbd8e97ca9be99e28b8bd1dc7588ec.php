...
} elseif ($_instance->childHasBeenRendered('aOWKX7h')) {
    $componentId = $_instance->getRenderedChildComponentId('aOWKX7h');
    $componentTag = $_instance->getRenderedChildComponentTagName('aOWKX7h');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aOWKX7h');
} else {
    $response = \Livewire\Livewire::mount('client-order');
    $html = $response->html();
    $_instance->logRenderedChild('aOWKX7h', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BUDDY\OneDrive\Desktop\soukaina-portfolio\resources\views/order.blade.php ENDPATH**/ ?>