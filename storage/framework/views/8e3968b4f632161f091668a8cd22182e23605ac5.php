            ...
            <div class="card-body pb-2">
                <form enctype="multipart/form-data">
                    ...
                    <div style="margin-bottom: 20px; text-align: right;">
                        <button type="button" wire:click="toggleAddDesign()"
                            class="btn btn-dark mt-4 mb-0">Close</button>
                        <button type="button" wire:click="store()" class="btn btn-success mt-4 mb-0"
...
<?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/livewire/design/create.blade.php ENDPATH**/ ?>