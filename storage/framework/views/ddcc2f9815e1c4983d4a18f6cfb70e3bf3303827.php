    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/admin/profile">Profile</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
} elseif ($_instance->childHasBeenRendered('QZH0eiY')) {
    $componentId = $_instance->getRenderedChildComponentId('QZH0eiY');
    $componentTag = $_instance->getRenderedChildComponentTagName('QZH0eiY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QZH0eiY');
} else {
    $response = \Livewire\Livewire::mount('profile');
    $html = $response->html();
    $_instance->logRenderedChild('QZH0eiY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BUDDY\OneDrive\Desktop\soukaina-portfolio\resources\views/admin/mains-admin/landing/profile.blade.php ENDPATH**/ ?>