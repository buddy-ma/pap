                        ...
                        <div class="col-md-4">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <?php else: ?>
                                        <img src="<?php echo e(asset("storage/icons/$service->icon")); ?>" class="avatar avatar-xxl brround"
                                            alt="">
                                    <?php endif; ?>
                                    ...
                                    <label class="custom-switch" wire:click="disable(<?php echo e($service->id); ?>)">
                                        <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input" <?php if($service->status == 1): ?> checked <?php endif; ?>>
                                        <span class="custom-switch-indicator"></span>
                                        <span class="custom-switch-description"><?php if($service->status == 1): ?> Enabled <?php else: ?> Disabled <?php endif; ?></span>
                                    </label>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /var/www/html/resources/views/livewire/admin-services.blade.php ENDPATH**/ ?>