...
} elseif ($_instance->childHasBeenRendered('YpAA0DV')) {
    $componentId = $_instance->getRenderedChildComponentId('YpAA0DV');
    $componentTag = $_instance->getRenderedChildComponentTagName('YpAA0DV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YpAA0DV');
} else {
    $response = \Livewire\Livewire::mount('profile');
    $html = $response->html();
    $_instance->logRenderedChild('YpAA0DV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/admin/mains-admin/landing/profile.blade.php ENDPATH**/ ?>