...
} elseif ($_instance->childHasBeenRendered('qTKanmv')) {
    $componentId = $_instance->getRenderedChildComponentId('qTKanmv');
    $componentTag = $_instance->getRenderedChildComponentTagName('qTKanmv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qTKanmv');
} else {
    $response = \Livewire\Livewire::mount('admin-products');
    $html = $response->html();
    $_instance->logRenderedChild('qTKanmv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/products.blade.php ENDPATH**/ ?>