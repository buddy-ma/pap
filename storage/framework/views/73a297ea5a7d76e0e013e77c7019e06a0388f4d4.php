        ...
        <div class="music-bg bg bg-shadow-top"
            ...
            <div class="text-center w-100" data-tilt data-tilt-max="3" data-tilt-perspective="500" data-tilt-speed="400">
                <div class="img-height">
                    <img alt="" class="img-fluid" src="<?php echo e(asset("storage/portfolio/$header->picture")); ?>">
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\BUDDY\OneDrive\Desktop\soukaina-portfolio\resources\views/dynamic/header/second.blade.php ENDPATH**/ ?>