...
} elseif ($_instance->childHasBeenRendered('AuU5jrS')) {
    $componentId = $_instance->getRenderedChildComponentId('AuU5jrS');
    $componentTag = $_instance->getRenderedChildComponentTagName('AuU5jrS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AuU5jrS');
} else {
    $response = \Livewire\Livewire::mount('product-listing');
    $html = $response->html();
    $_instance->logRenderedChild('AuU5jrS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
