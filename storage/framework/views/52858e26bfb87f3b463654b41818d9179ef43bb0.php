...
} elseif ($_instance->childHasBeenRendered('kEG9wLL')) {
    $componentId = $_instance->getRenderedChildComponentId('kEG9wLL');
    $componentTag = $_instance->getRenderedChildComponentTagName('kEG9wLL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kEG9wLL');
} else {
    $response = \Livewire\Livewire::mount('client-order');
    $html = $response->html();
    $_instance->logRenderedChild('kEG9wLL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio - soukaina\resources\views/order.blade.php ENDPATH**/ ?>