...
} elseif ($_instance->childHasBeenRendered('wsYyZYb')) {
    $componentId = $_instance->getRenderedChildComponentId('wsYyZYb');
    $componentTag = $_instance->getRenderedChildComponentTagName('wsYyZYb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wsYyZYb');
} else {
    $response = \Livewire\Livewire::mount('admin-numbers');
    $html = $response->html();
    $_instance->logRenderedChild('wsYyZYb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/landing/numbers.blade.php ENDPATH**/ ?>