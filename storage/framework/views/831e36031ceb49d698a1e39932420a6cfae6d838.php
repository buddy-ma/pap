    <aside class="app-sidebar">
            ...
            <a class="header-brand" href="<?php echo e(url('/' . ($page = ''))); ?>">
                <?php if($logo): ?>
                    <img src="<?php echo e(URL::asset("$logo")); ?>" style='height:4rem' class="header-brand-img desktop-lgo"
                        alt="Admin logo">
                    <img src="<?php echo e(URL::asset("$logo")); ?>" class="header-brand-img dark-logo" alt="Admin logo">
                <?php else: ?>
        ...
        <ul class="side-menu app-sidebar3">
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(url('/admin/status')); ?>">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" width="24"
                        viewBox="0 0 24 24">
                        <path
                            d="M14.25 21.4q-.575.575-1.425.575-.85 0-1.425-.575l-8.8-8.8q-.275-.275-.437-.65Q2 11.575 2 11.15V4q0-.825.588-1.413Q3.175 2 4 2h7.15q.425 0 .8.162.375.163.65.438l8.8 8.825q.575.575.575 1.412 0 .838-.575 1.413ZM12.825 20l7.15-7.15L11.15 4H4v7.15ZM6.5 8q.625 0 1.062-.438Q8 7.125 8 6.5t-.438-1.062Q7.125 5 6.5 5t-1.062.438Q5 5.875 5 6.5t.438 1.062Q5.875 8 6.5 8ZM4 4Z" />
                    </svg>
                    <span class="side-menu__label">Statuses</span>
                </a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(url('/admin/emails')); ?>">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" width="24"
                        viewBox="0 0 24 24">
                        <path
                            d="M14.25 21.4q-.575.575-1.425.575-.85 0-1.425-.575l-8.8-8.8q-.275-.275-.437-.65Q2 11.575 2 11.15V4q0-.825.588-1.413Q3.175 2 4 2h7.15q.425 0 .8.162.375.163.65.438l8.8 8.825q.575.575.575 1.412 0 .838-.575 1.413ZM12.825 20l7.15-7.15L11.15 4H4v7.15ZM6.5 8q.625 0 1.062-.438Q8 7.125 8 6.5t-.438-1.062Q7.125 5 6.5 5t-1.062.438Q5 5.875 5 6.5t.438 1.062Q5.875 8 6.5 8ZM4 4Z" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(url('/admin/designs')); ?>">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                        height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                        <g>
                            <rect fill="none" height="24" width="24" x="0" />
            ...
            <li class="side-item side-item-category mt-4">Extra</li>

            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(url('/admin/settings')); ?>">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                        height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                        <g>
                            <rect fill="none" height="24" width="24" x="0" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(url('/admin/translation')); ?>">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                        height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                        <g>
                            <rect fill="none" height="24" width="24" x="0" />
                    ...
                    <span class="side-menu__label">Translation</span>
                </a>
            </li>
        </ul>
    </aside>
    <!--aside closed-->
<?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/layouts/aside-menu.blade.php ENDPATH**/ ?>