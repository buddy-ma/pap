...
} elseif ($_instance->childHasBeenRendered('TDyuAxr')) {
    $componentId = $_instance->getRenderedChildComponentId('TDyuAxr');
    $componentTag = $_instance->getRenderedChildComponentTagName('TDyuAxr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TDyuAxr');
} else {
    $response = \Livewire\Livewire::mount('roles');
    $html = $response->html();
    $_instance->logRenderedChild('TDyuAxr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/user/role-list.blade.php ENDPATH**/ ?>