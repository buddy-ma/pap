                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-4 mb-4">
                                    ...
                                    <input class="form-control mb-4" placeholder="Permission title" type="text"
                                        wire:model='title' value='<?php echo e(old('title')); ?>'>
                                </div>
                                <div class="col-4 mb-4">
                                    ...
                                    <input class="form-control mb-4" placeholder="Permission groupe" type="text"
                                        wire:model='groupe' value='<?php echo e(old('groupe')); ?>'>
                                </div>
                            </div>
...
<?php /**PATH /var/www/html/resources/views/livewire/admin/permissions/permissions-add.blade.php ENDPATH**/ ?>