        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body pb-2">
                    ...
                    <form method="post" action="<?php echo e(route('ville-add')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg">
                                <label>Title*</label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/admin/mains-admin/villes/ville-add.blade.php ENDPATH**/ ?>