...
} elseif ($_instance->childHasBeenRendered('F39Bg6Y')) {
    $componentId = $_instance->getRenderedChildComponentId('F39Bg6Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('F39Bg6Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F39Bg6Y');
} else {
    $response = \Livewire\Livewire::mount('contact-livewire');
    $html = $response->html();
    $_instance->logRenderedChild('F39Bg6Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </section>  
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\buddy_old\resources\views/home.blade.php ENDPATH**/ ?>