    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/admin/profile">Numbers</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
} elseif ($_instance->childHasBeenRendered('eeWGGua')) {
    $componentId = $_instance->getRenderedChildComponentId('eeWGGua');
    $componentTag = $_instance->getRenderedChildComponentTagName('eeWGGua');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eeWGGua');
} else {
    $response = \Livewire\Livewire::mount('admin-numbers');
    $html = $response->html();
    $_instance->logRenderedChild('eeWGGua', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/numbers.blade.php ENDPATH**/ ?>