...
} elseif ($_instance->childHasBeenRendered('k3F2Nxp')) {
    $componentId = $_instance->getRenderedChildComponentId('k3F2Nxp');
    $componentTag = $_instance->getRenderedChildComponentTagName('k3F2Nxp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('k3F2Nxp');
} else {
    $response = \Livewire\Livewire::mount('blog-listing-new');
    $html = $response->html();
    $_instance->logRenderedChild('k3F2Nxp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/blogs/blog-new.blade.php ENDPATH**/ ?>