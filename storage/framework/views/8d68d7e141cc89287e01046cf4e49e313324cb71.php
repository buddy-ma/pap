...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('blog-listing-decouvrez-new')->html();
} elseif ($_instance->childHasBeenRendered('nIKxqKg')) {
    $componentId = $_instance->getRenderedChildComponentId('nIKxqKg');
    $componentTag = $_instance->getRenderedChildComponentTagName('nIKxqKg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nIKxqKg');
} else {
    $response = \Livewire\Livewire::mount('blog-listing-decouvrez-new');
    $html = $response->html();
    $_instance->logRenderedChild('nIKxqKg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/blogs/blog-decouvrez-new.blade.php ENDPATH**/ ?>