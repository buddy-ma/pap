...
<?php $__env->startSection('css'); ?>
    ...
    <style>
        ...
        .screenshot {
            background: url('<?php echo e(asset('admin_assets/images/screenshots/header2.png')); ?>');
    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="/admin/header">Header</a></li>
            </ol>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
} elseif ($_instance->childHasBeenRendered('I5ck5w9')) {
    $componentId = $_instance->getRenderedChildComponentId('I5ck5w9');
    $componentTag = $_instance->getRenderedChildComponentTagName('I5ck5w9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('I5ck5w9');
} else {
    $response = \Livewire\Livewire::mount('admin-header');
    $html = $response->html();
    $_instance->logRenderedChild('I5ck5w9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BUDDY\OneDrive\Desktop\soukaina-portfolio\resources\views/admin/mains-admin/landing/header.blade.php ENDPATH**/ ?>