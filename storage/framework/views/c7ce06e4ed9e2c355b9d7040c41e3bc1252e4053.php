...
} elseif ($_instance->childHasBeenRendered('P9CC4Kh')) {
    $componentId = $_instance->getRenderedChildComponentId('P9CC4Kh');
    $componentTag = $_instance->getRenderedChildComponentTagName('P9CC4Kh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('P9CC4Kh');
} else {
    $response = \Livewire\Livewire::mount('admin-services');
    $html = $response->html();
    $_instance->logRenderedChild('P9CC4Kh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/services.blade.php ENDPATH**/ ?>