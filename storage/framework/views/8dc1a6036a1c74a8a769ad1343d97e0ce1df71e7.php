    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="<?php echo e(url('/' . ($page = ''))); ?>">
                <img src="<?php echo e(URL::asset('assets/images/buddy/header_logo.svg')); ?>" class="header-brand-img desktop-lgo"
                    alt="Buddy logo">
                <img src="<?php echo e(URL::asset('assets/images/buddy/header_logo.svg')); ?>" class="header-brand-img dark-logo"
                    alt="Buddy logo">
...
<!--/app header-->
<?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>