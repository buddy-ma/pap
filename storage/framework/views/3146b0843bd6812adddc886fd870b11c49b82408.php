...
<div class="row flex-lg-nowrap">
    <div class="col-12">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('status')->html();
} elseif ($_instance->childHasBeenRendered('l8wKVBv')) {
    $componentId = $_instance->getRenderedChildComponentId('l8wKVBv');
    $componentTag = $_instance->getRenderedChildComponentTagName('l8wKVBv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l8wKVBv');
} else {
    $response = \Livewire\Livewire::mount('status');
    $html = $response->html();
    $_instance->logRenderedChild('l8wKVBv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Soukaina Artist\portfolio\resources\views/admin/mains-admin/landing/status.blade.php ENDPATH**/ ?>