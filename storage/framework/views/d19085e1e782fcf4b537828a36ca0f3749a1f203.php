...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row flex-lg-nowrap">
        <div class="col-12">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('permissions')->html();
} elseif ($_instance->childHasBeenRendered('Z1cgA4u')) {
    $componentId = $_instance->getRenderedChildComponentId('Z1cgA4u');
    $componentTag = $_instance->getRenderedChildComponentTagName('Z1cgA4u');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Z1cgA4u');
} else {
    $response = \Livewire\Livewire::mount('permissions');
    $html = $response->html();
    $_instance->logRenderedChild('Z1cgA4u', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/mains-admin/user/permission-list.blade.php ENDPATH**/ ?>