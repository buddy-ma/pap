...
} elseif ($_instance->childHasBeenRendered('M6FOtce')) {
    $componentId = $_instance->getRenderedChildComponentId('M6FOtce');
    $componentTag = $_instance->getRenderedChildComponentTagName('M6FOtce');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('M6FOtce');
} else {
    $response = \Livewire\Livewire::mount('edit-product', ['id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('M6FOtce', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
