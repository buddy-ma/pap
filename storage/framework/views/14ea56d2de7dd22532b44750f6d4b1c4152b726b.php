        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body pb-2">
                    ...
                    <form method="post" action="<?php echo e(route('commercialiser-page-store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg">
                                <label>Title*</label>
                                <input type="text" name="title" value="<?php echo e($page->title ?? ''); ?>"
                                    class="form-control" />
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-lg">
                                <label>Adresse*</label>
                                <input type="text" name="address" value="<?php echo e($page->address ?? ''); ?>"
                                    class="form-control" />
                            </div>
                            <div class="col-lg">
                                <label>Telephone*</label>
                                <input type="text" name="phone" value="<?php echo e($page->phone ?? ''); ?>"
                                    class="form-control" />
                            </div>
                            <div class="col-lg">
                                <label>Email*</label>
                                <input type="text" name="email" value="<?php echo e($page->email ?? ''); ?>"
                                    class="form-control" />
                            </div>
                        </div>
                        <div class="row mt-4">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ayman\Desktop\Project\pap\resources\views/admin/mains-admin/commercialiser/commercialiser-page.blade.php ENDPATH**/ ?>