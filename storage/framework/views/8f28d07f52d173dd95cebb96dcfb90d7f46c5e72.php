...
} elseif ($_instance->childHasBeenRendered('JB2JwFt')) {
    $componentId = $_instance->getRenderedChildComponentId('JB2JwFt');
    $componentTag = $_instance->getRenderedChildComponentTagName('JB2JwFt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JB2JwFt');
} else {
    $response = \Livewire\Livewire::mount('users');
    $html = $response->html();
    $_instance->logRenderedChild('JB2JwFt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
