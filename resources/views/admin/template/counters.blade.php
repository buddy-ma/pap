...
@section('content')
						...
						<div class="row">
							...
							<div class="col-md-12 col-xl-4">
								<div class="card overflow-hidden">
									<a href="#"><img class="card-img-top " src="{{URL::asset('admin_assets/images/photos/9.jpg')}}" alt="img"></a>
									<div class="card-body d-flex flex-column">
							...
							<div class="col-md-12 col-xl-4">
								<div class="card overflow-hidden">
									<a href="#"><img class="card-img-top " src="{{URL::asset('admin_assets/images/photos/10.jpg')}}" alt="img"></a>
									<div class="card-body d-flex flex-column">
...
@section('js')
		...
		<script src="{{URL::asset('admin_assets/plugins/countdown/moment.min.js')}}"></script>
		<script src="{{URL::asset('admin_assets/plugins/countdown/moment-timezone.min.js')}}"></script>
		<script src="{{URL::asset('admin_assets/plugins/countdown/moment-timezone-with-data.min.js')}}"></script>
		<script src="{{URL::asset('admin_assets/plugins/countdown/countdowntime.js')}}"></script>
		<script src="{{URL::asset('admin_assets/js/counterup.js')}}"></script>
@endsection
