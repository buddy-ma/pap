									...
									<div class="card-group mb-0">
										<div class="card p-4">
											<div class="card-body">
												<div class="text-center mb-4 ">
													<span class="avatar avatar-xxl  brround" style="background-image: url({{URL::asset('admin_assets/images/users/2.jpg')}}"></span>
												</div>
										...
										<div class="card text-white bg-primary py-5 d-md-down-none page-content mt-0">
											<div class="text-center justify-content-center page-single-content">
												...
												<img src="{{URL::asset('admin_assets/images/png/login.png')}}" alt="img">
											</div>
										</div>
									</div>
								</div>
