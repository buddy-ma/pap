								...
								<div class="col-lg-8">
									<div class="box-widget widget-user">
										<div class="widget-user-image1 d-sm-flex">
											<img alt="User Avatar" class="rounded-circle border p-0" src="{{URL::asset('admin_assets/images/users/2.jpg')}}">
												...
												<div class="row">
													<div class="col-lg-6">
														<div class="d-flex align-items-center border p-3 mb-3 br-7">
															<div class="avatar avatar-lg brround d-block cover-image" data-image-src="{{URL::asset('admin_assets/images/users/7.jpg')}}" >
															</div>
													...
													<div class="col-lg-6">
														<div class="d-flex align-items-center border p-3 mb-3 br-7">
															<div class="avatar avatar-lg brround d-block cover-image" data-image-src="{{URL::asset('admin_assets/images/users/6.jpg')}}" >
															</div>
															<div class="wrapper ml-3">
													...
													<div class="col-lg-6">
														<div class="d-flex align-items-center border p-3 mb-3 br-7">
															<div class="avatar avatar-lg brround d-block cover-image" data-image-src="{{URL::asset('admin_assets/images/users/5.jpg')}}" >
															</div>
															<div class="wrapper ml-3">
													...
													<div class="col-lg-6">
														<div class="d-flex align-items-center border p-3 mb-3 br-7">
															<div class="avatar avatar-lg brround d-block cover-image" data-image-src="{{URL::asset('admin_assets/images/users/1.jpg')}}" >
															</div>
															<div class="wrapper ml-3">
													...
													<div class="col-lg-6">
														<div class="d-flex align-items-center border p-3 mb-3 br-7">
															<div class="avatar avatar-lg brround d-block cover-image" data-image-src="{{URL::asset('admin_assets/images/users/8.jpg')}}" >
															</div>
															<div class="wrapper ml-3">
													...
													<div class="col-lg-6">
														<div class="d-flex align-items-center border p-3 mb-3 br-7">
															<div class="avatar avatar-lg brround d-block cover-image" data-image-src="{{URL::asset('admin_assets/images/users/3.jpg')}}" >
															</div>
															<div class="wrapper ml-3">
													...
													<div class="col-lg-6">
														<div class="d-flex align-items-center border p-3 mb-3 br-7">
															<div class="avatar avatar-lg brround d-block cover-image" data-image-src="{{URL::asset('admin_assets/images/users/4.jpg')}}" >
															</div>
															<div class="wrapper ml-3">
													...
													<div class="col-lg-6">
														<div class="d-flex align-items-center border p-3 mb-3 br-7">
															<div class="avatar avatar-lg brround d-block cover-image" data-image-src="{{URL::asset('admin_assets/images/users/9.jpg')}}" >
															</div>
															<div class="wrapper ml-3">
											...
											<ul class="timelineleft pb-5">
												...
												<li>
													...
													<div class="timelineleft-item">
														...
														<div class="timelineleft-body">
															<img src="{{URL::asset('admin_assets/images/photos/1.jpg')}}" alt="..." class="margin mt-2 mb-2">
															<img src="{{URL::asset('admin_assets/images/photos/2.jpg')}}" alt="..." class="margin mt-2 mb-2 ">
															<img src="{{URL::asset('admin_assets/images/photos/3.jpg')}}" alt="..." class="margin mt-2 mb-2 ">
															<img src="{{URL::asset('admin_assets/images/photos/4.jpg')}}" alt="..." class="margin mt-2 mb-2">
														</div>
													</div>
												</li>
												<li>
