...
@section('css')
		...
		<link href="{{URL::asset('admin_assets/plugins/forn-wizard/css/forn-wizard.css')}}" rel="stylesheet" />
		<link href="{{URL::asset('admin_assets/plugins/formwizard/smart_wizard.css')}}" rel="stylesheet">
		<link href="{{URL::asset('admin_assets/plugins/formwizard/smart_wizard_theme_dots.css')}}" rel="stylesheet">
@endsection
@section('page-header')
						<!--Page header-->
...
@section('js')
		...
		<script src="{{URL::asset('admin_assets/plugins/formwizard/jquery.smartWizard.js')}}"></script>
		<script src="{{URL::asset('admin_assets/plugins/formwizard/fromwizard.js')}}"></script>

		<!-- INTERNAl Accordion-Wizard-Form js-->
		<script src="{{URL::asset('admin_assets/plugins/accordion-Wizard-Form/jquery.accordion-wizard.min.js')}}"></script>
		<script src="{{URL::asset('admin_assets/js/form-wizard.js')}}"></script>
		<script src="{{URL::asset('admin_assets/js/form-wizard2.js')}}"></script>
@endsection
