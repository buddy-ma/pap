								...
								<div class="row">
										...
										<div class="card border p-0 shadow-none">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="{{URL::asset('admin_assets/images/files/file.png')}}" alt="img" class="br-7">
												</div>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="{{URL::asset('admin_assets/images/files/folder.png')}}" alt="img" class="br-7">
												</div>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="{{URL::asset('admin_assets/images/photos/1.jpg')}}" alt="img" class="br-7">
												</div>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="{{URL::asset('admin_assets/images/files/word.png')}}" alt="img" class="br-7">
												</div>
