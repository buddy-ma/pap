												...
												<div class="row">
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																<div class="avatar avatar-xxl brround d-block cover-image mx-auto" data-image-src="{{URL::asset('admin_assets/images/users/7.jpg')}}">	</div>
													...
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																<div class="avatar avatar-xxl brround d-block cover-image mx-auto" data-image-src="{{URL::asset('admin_assets/images/users/1.jpg')}}">	</div>
																<div class="wrapper mt-3">
													...
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																<div class="avatar avatar-xxl brround d-block cover-image mx-auto" data-image-src="{{URL::asset('admin_assets/images/users/2.jpg')}}">	</div>
																<div class="wrapper mt-3">
													...
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																<div class="avatar avatar-xxl brround d-block cover-image mx-auto" data-image-src="{{URL::asset('admin_assets/images/users/3.jpg')}}">	</div>
																<div class="wrapper mt-3">
													...
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																<div class="avatar avatar-xxl brround d-block cover-image mx-auto" data-image-src="{{URL::asset('admin_assets/images/users/4.jpg')}}">	</div>
																<div class="wrapper mt-3">
													...
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																<div class="avatar avatar-xxl brround d-block cover-image mx-auto" data-image-src="{{URL::asset('admin_assets/images/users/5.jpg')}}">	</div>
																<div class="wrapper mt-3">
													...
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																<div class="avatar avatar-xxl brround d-block cover-image mx-auto" data-image-src="{{URL::asset('admin_assets/images/users/6.jpg')}}">	</div>
																<div class="wrapper mt-3">
													...
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																<div class="avatar avatar-xxl brround d-block cover-image mx-auto" data-image-src="{{URL::asset('admin_assets/images/users/8.jpg')}}">	</div>
																<div class="wrapper mt-3">
													...
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																<div class="avatar avatar-xxl brround d-block cover-image mx-auto" data-image-src="{{URL::asset('admin_assets/images/users/9.jpg')}}">	</div>
																<div class="wrapper mt-3">
