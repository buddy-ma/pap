...
@section('css')
		...
		<link href="{{URL::asset('admin_assets/plugins/sweet-alert/jquery.sweet-modal.min.css')}}" rel="stylesheet" />
...
@section('js')
		...
		<script src="{{URL::asset('admin_assets/plugins/sweet-alert/jquery.sweet-modal.min.js')}}"></script>
