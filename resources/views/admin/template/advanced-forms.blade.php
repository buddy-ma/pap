...
@section('css')
        ...
        <link href="{{URL::asset('admin_assets/plugins/time-picker/jquery.timepicker.css')}}" rel="stylesheet" />
        ...
        <link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/telephoneinput/telephoneinput.css')}}">
								...
								<form method="post" class="card">
									...
									<div class=" card-body">
										<div class="row">
											...
											<div class="col-lg-4 col-sm-12">
												<input type="file" class="dropify" data-default-file="{{URL::asset('admin_assets/images/photos/media1.jpg')}}" data-height="180"  />
											</div>
											<div class="col-lg-4 col-sm-12">
