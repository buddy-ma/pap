...
@section('css')
		...
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/css/examples.css')}}">

		<!-- INTERNAl Themes  css-->
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/bars-1to10.css')}}">
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/bars-movie.css')}}">
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/bars-square.css')}}">
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/bars-pill.css')}}">
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/bars-reversed.css')}}">
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/bars-horizontal.css')}}">
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/fontawesome-stars.css')}}">
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/css-stars.css')}}">
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/bootstrap-stars.css')}}">
		<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/rating/dist/themes/fontawesome-stars-o.css')}}">
@endsection
@section('page-header')
						<!--Page header-->
...
@section('js')
		...
		<script src="{{URL::asset('admin_assets/plugins/rating/js/examples.js')}}"></script>
@endsection
