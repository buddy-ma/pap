						...
						<div class="row">
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/1.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/2.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/3.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
									...
									<div class="card-body">
										<div class="d-flex align-items-center mt-auto">
											<div class="avatar brround avatar-md mr-3" style="background-image:  url{{URL::asset('admin_assets/images/users/1.jpg')}}"></div>
											<div>
												<a href="{{url('/' . $page='profile')}}" class="font-weight-semibold">Anna Ogden</a>
												<small class="d-block text-muted">2 days ago</small>
											</div>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/4.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
									...
									<div class="card-body">
										<div class="d-flex align-items-center mt-auto">
											<div class="avatar brround avatar-md mr-3" style="background-image:  url{{URL::asset('admin_assets/images/users/13.jpg')}}"></div>
											<div>
												<a href="{{url('/' . $page='profile')}}" class="font-weight-semibold">Anna Ogden</a>
												<small class="d-block text-muted">2 days ago</small>
											</div>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/5.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/6.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/7.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/8.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
									...
									<div class="card-body">
										<div class="d-flex align-items-center mt-auto">
											<div class="avatar brround avatar-md mr-3" style="background-image:  url{{URL::asset('admin_assets/images/users/5.jpg')}}"></div>
											<div>
												<a href="{{url('/' . $page='profile')}}" class="font-weight-semibold">Anna Ogden</a>
												<small class="d-block text-muted">2 days ago</small>
											</div>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/9.jpg')}}" alt="img" class="cover-image w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
									...
									<div class="card-body">
										<div class="d-flex align-items-center mt-auto">
											<div class="avatar brround avatar-md mr-3" style="background-image:  url{{URL::asset('admin_assets/images/users/8.jpg')}}"></div>
											<div>
												<a href="{{url('/' . $page='profile')}}" class="font-weight-semibold">Anna Ogden</a>
												<small class="d-block text-muted">2 days ago</small>
											</div>
