										...
										<div class="card">
											<div class="card-body p-0">
												...
												<div class="px-5 pb-5 text-center">
													<img src="{{URL::asset('admin_assets/images/files/file2.png')}}" alt="img" class="w-80 mx-auto">
									...
									<div class="col-xl-3 col-lg-4 col-md-6">
										<div class="card">
											<div class="card-body p-0">
												...
												<div class="px-5 pb-5 text-center">
													<img src="{{URL::asset('admin_assets/images/files/doc.png')}}" alt="img" class="w-80 mx-auto">
									...
									<div class="col-xl-3 col-lg-4 col-md-6">
										<div class="card">
											<div class="card-body p-0">
												...
												<div class="px-5 pb-5 text-center">
													<img src="{{URL::asset('admin_assets/images/files/file.png')}}" alt="img" class="w-80 mx-auto">
									...
									<div class="col-xl-3 col-lg-4 col-md-6">
										<div class="card">
											<div class="card-body p-0">
												...
												<div class="px-5 pb-5 text-center">
													<img src="{{URL::asset('admin_assets/images/files/ppt.png')}}" alt="img" class="w-80 mx-auto">
									...
									<div class="col-xl-3 col-lg-4 col-md-6">
										<div class="card">
											<div class="card-body p-0">
												...
												<div class="px-5 pb-5 text-center">
													<img src="{{URL::asset('admin_assets/images/files/word.png')}}" alt="img" class="w-80 mx-auto">
									...
									<div class="col-xl-3 col-lg-4 col-md-6">
										<div class="card">
											<div class="card-body p-0">
												...
												<div class="px-5 pb-5 text-center">
													<img src="{{URL::asset('admin_assets/images/files/zip.png')}}" alt="img" class="w-80 mx-auto">
