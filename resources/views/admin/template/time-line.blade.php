							...
							<div class="col-lg-8">
								<div class="card">
									...
									<div class="card-body d-flex border-top">
										<div class="mr-4"><img alt="" class="rounded-circle avatar avatar-md" src="{{URL::asset('admin_assets/images/users/2.jpg')}}"></div>
										<form class="w-100">
										...
										<div class="d-flex">
											<div class="media mt-0">
												<div class="media-user mr-2">
													<div class=""><img alt="" class="rounded-circle avatar avatar-md" src="{{URL::asset('admin_assets/images/users/2.jpg')}}"></div>
												</div>
								...
								<div class="card overflow-hidden">
									<div class="card-body pb-0">
										...
										<div class="mt-4">
											<p class="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
											<div class="d-flex">
												<img src="{{URL::asset('admin_assets/images/photos/2.jpg')}}" alt="img" class="w-40 m-1">
												<img src="{{URL::asset('admin_assets/images/photos/3.jpg')}}" alt="img" class="w-40 m-1">
											</div>
										</div>
										<div class="media mg-t-15 profile-footer">
											<div class="media-user mr-2 mt-1">
								...
								<div class="card overflow-hidden">
									<div class="card-body pb-0">
										...
										<div class="mt-4">
											<p class="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
											<div class="d-flex">
												<img src="{{URL::asset('admin_assets/images/photos/4.jpg')}}" alt="img" class="w-30 m-1">
												<img src="{{URL::asset('admin_assets/images/photos/5.jpg')}}" alt="img" class="w-30 m-1">
												<img src="{{URL::asset('admin_assets/images/photos/6.jpg')}}" alt="img" class="w-30 m-1">
											</div>
										</div>
										<div class="media mg-t-15 profile-footer">
											<div class="media-user mr-2 mt-1">
...
@section('js')
		...
		<script src="{{URL::asset('admin_assets/plugins/timeline/js/jquery.timelify.js')}}"></script>
		<script src="{{URL::asset('admin_assets/js/timeline.js')}}"></script>
@endsection
