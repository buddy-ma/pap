...
@section('js')
		...
		<!-- INTERNAl Chart js -->
		<script src="{{URL::asset('admin_assets/plugins/chart/chart.min.js')}}"></script>
		<script src="{{URL::asset('admin_assets/plugins/chart/chart.extension.js')}}"></script>

		<!-- INTERNAl Widgets js-->
		<script src="{{URL::asset('admin_assets/js/widgets.js')}}"></script>
@endsection
