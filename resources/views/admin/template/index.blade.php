              ...
              <div class="page-rightheader">
                  <div class="btn btn-list">
                      ...
                      <a href="{{ url('/' . ($page = '#')) }}" class="btn btn-warning"><i
                              class="fe fe-shopping-cart mr-1"></i>
                          Buy Now </a>
                  </div>
              </div>
          </div>
                      ...
                      <div class="card-body">
                          <div class="country-card">
                              <div class="mb-5">
                                  <div class="d-flex">
                                      <span class=""><img
                                              src="{{ URL::asset('admin_assets/images/flags/us.svg') }}"
                              ...
                              <div class="mb-5">
                                  <div class="d-flex">
                                      <span class=""><img
                                              src="{{ URL::asset('admin_assets/images/flags/in.svg') }}"
                              ...
                              <div class="mb-5">
                                  <div class="d-flex">
                                      <span class=""><img
                                              src="{{ URL::asset('admin_assets/images/flags/ru.svg') }}"
                              ...
                              <div class="mb-5">
                                  <div class="d-flex">
                                      <span class=""><img
                                              src="{{ URL::asset('admin_assets/images/flags/ca.svg') }}"
                              ...
                              <div class="mb-5">
                                  <div class="d-flex">
                                      <span class=""><img
                                              src="{{ URL::asset('admin_assets/images/flags/ge.svg') }}"
                              ...
                              <div class="mb-5">
                                  <div class="d-flex">
                                      <span class=""><img
                                              src="{{ URL::asset('admin_assets/images/flags/br.svg') }}"
                              ...
                              <div class="mb-0">
                                  <div class="d-flex">
                                      <span class=""><img
                                              src="{{ URL::asset('admin_assets/images/flags/au.svg') }}"
                                  ...
                                  <tbody>
                                      <tr>
                                          <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                  src="{{ URL::asset('admin_assets/images/orders/7.jpg') }}"
                                      ...
                                      <tr>
                                          <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                  src="{{ URL::asset('admin_assets/images/orders/8.jpg') }}"
                                      ...
                                      <tr>
                                          <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                  src="{{ URL::asset('admin_assets/images/orders/9.jpg') }}"
                                      ...
                                      <tr>
                                          <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                  src="{{ URL::asset('admin_assets/images/orders/10.jpg') }}"
                                      ...
                                      <tr>
                                          <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                  src="{{ URL::asset('admin_assets/images/orders/12.jpg') }}"
                                                  alt="media1"> Watch</td>
                                      ...
                                      <tr>
                                          <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                  src="{{ URL::asset('admin_assets/images/orders/13.jpg') }}"
                                      ...
                                      <tr class="mb-0">
                                          <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                  src="{{ URL::asset('admin_assets/images/orders/11.jpg') }}"
