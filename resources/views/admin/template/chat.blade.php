												...
												<div class="tab-pane active" id="tab-7">
													<ul class="list-group lg-alt chat-conatct-list" id="ChatList">
														<li class="list-group-item media p-4 mt-0 border-0">
															<a href="#">
																<div class="float-left pr-2">
																	<img src="{{URL::asset('admin_assets/images/users/5.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="float-left pr-2">
																	<img src="{{URL::asset('admin_assets/images/users/2.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="float-left pr-2">
																	<img src="{{URL::asset('admin_assets/images/users/7.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="lv-avatar float-left pr-2">
																	<img src="{{URL::asset('admin_assets/images/users/3.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="lv-avatar float-left pr-2">
																	<img src="{{URL::asset('admin_assets/images/users/9.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="float-left pr-2">
																	<img src="{{URL::asset('admin_assets/images/users/6.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
										...
										<div class="ms-body">
											<div class="action-header clearfix">
												...
												<div class="float-left hidden-xs d-flex ml-4 chat-user">
													<img src="{{URL::asset('admin_assets/images/users/2.jpg')}}" alt="" class="avatar avatar-lg brround mr-2">
											...
											<div class="chat-body-style" id="ChatBody">
												...
												<div class="message-feed right">
													<div class="float-right pl-2">
														<img src="{{URL::asset('admin_assets/images/users/10.jpg')}}" alt="" class="avatar avatar-md brround">
													</div>
													<div class="media-body">
														<div class="mf-content">
															...
															<div class="row mt-2">
																<div class="col-4">
																	<img class="img-fluid rounded" src="{{URL::asset('admin_assets/images/photos/19.jpg')}}" alt="banner image">
																</div>
																<div class="col-4">
																	<img class="img-fluid rounded" src="{{URL::asset('admin_assets/images/photos/11.jpg')}}" alt="banner image">
																</div>
																<div class="col-4">
																	<img class="img-fluid rounded" src="{{URL::asset('admin_assets/images/photos/8.jpg ')}}" alt="banner image">
																</div>
															</div>
														</div>
