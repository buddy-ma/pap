											...
											<div class="container">
												<div class="d-flex">
													<a class="header-brand" href="{{url('/' . $page='index')}}">
														<img src="{{URL::asset('admin_assets/images/brand/logo.png')}}" class="header-brand-img desktop-lgo" alt="Admintro logo">
														<img src="{{URL::asset('admin_assets/images/brand/logo1.png')}}" class="header-brand-img dark-logo" alt="Admintro logo">
													</a>
													<div class="d-flex order-lg-2 ml-auto">
														...
														<div class="dropdown d-none d-md-flex mt-1">
															...
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
																...
																<a href="#" class="dropdown-item d-flex pb-3">
																	<span class="avatar brround mr-3 align-self-center" style="background-image: url({{URL::asset('admin_assets/images/users/4.jpg')}})"></span>
																	<div>
																...
																<a href="#" class="dropdown-item d-flex pb-3">
																	<span class="avatar brround mr-3 align-self-center" style="background-image: url({{URL::asset('admin_assets/images/users/1.jpg')}})"></span>
																	<div>
																...
																<a href="#" class="dropdown-item d-flex pb-3">
																	<span class="avatar brround mr-3 align-self-center" style="background-image: url({{URL::asset('admin_assets/images/users/8.jpg')}})"></span>
																	<div>
														...
														<div class="dropdown ">
															<a href="#" class="nav-link pr-0 leading-none mt-1" data-toggle="dropdown">
																<span class="avatar avatar-md brround" style="background-image: url({{URL::asset('admin_assets/images/users/2.jpg')}})"></span>
															</a>
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
									...
									<div class="">
										<div class="header py-4 bg-primary br-bl-7 br-br-7">
											<div class="container">
												<div class="d-flex">
													<a class="header-brand" href="{{url('/' . $page='index')}}">
														<img src="{{URL::asset('admin_assets/images/brand/logo1.png')}}" class="header-brand-img desktop-lgo" alt="Admintro logo">
														<img src="{{URL::asset('admin_assets/images/brand/logo1.png')}}" class="header-brand-img dark-logo" alt="Admintro logo">
													</a>
													<div class="d-flex order-lg-2 ml-auto">
													...
													<div class="d-flex order-lg-2 ml-auto">
														...
														<div class="dropdown profile-dropdown mt-1">
															<a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
																<span>
																	<img src="{{URL::asset('admin_assets/images/users/2.jpg')}}" alt="img" class="avatar avatar-md brround">
																</span>
															</a>
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
																<div class="text-center">
