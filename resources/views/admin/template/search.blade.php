											...
											<div class="col-sm-6 col-lg-3">
												<a class="" href="#">
													<div class="border p-0 text-center m-1">
														<img src="{{URL::asset('admin_assets/images/photos/temp1.jpg')}}" alt="img" class="mx-auto">
													</div>
												</a>
											</div>
											<div class="col-sm-6 col-lg-3">
												<a class="" href="#">
													<div class="border p-0 text-center m-1">
														<img src="{{URL::asset('admin_assets/images/photos/temp3.jpg')}}" alt="img" class="mx-auto">
													</div>
												</a>
											</div>
											<div class="col-sm-6 col-lg-3">
												<a class="" href="#">
													<div class="border p-0 text-center m-1">
														<img src="{{URL::asset('admin_assets/images/photos/temp2.jpg')}}" alt="img" class="mx-auto">
													</div>
												</a>
											</div>
											<div class="col-sm-6 col-lg-3">
												<a class="" href="#">
													<div class="border p-0 text-center m-1">
														<img src="{{URL::asset('admin_assets/images/photos/temp4.jpg')}}" alt="img" class="mx-auto">
													</div>
												</a>
											</div>
										</div>
								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<ul class="list-unstyled video-list-thumbs row">
                                            <li class="col-sm-6 col-lg-2 col-md-2 border-0">
                                                <a href="#" title="sed do eiusmod tempor incidi dunt ut labore et dolore magna">
                                                    <img alt="Barca" class="img-responsive" src="{{URL::asset('admin_assets/images/photos/1.jpg')}}">
                                                </a>
                                            </li>
