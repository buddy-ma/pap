...
@section('css')
		...
		<link href="{{URL::asset('admin_assets/plugins/img-crop/cropme.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
						<!--Page header-->
...
@section('js')
		...
		<script src="{{URL::asset('admin_assets/plugins/img-crop/vue.js')}}"></script>
		<script src="{{URL::asset('admin_assets/plugins/img-crop/cropme.js')}}"></script>
		<script src="{{URL::asset('admin_assets/js/img-crop.js')}}"></script>
@endsection
