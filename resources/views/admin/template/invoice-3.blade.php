																...
																<ul class="nav panel-tabs">
																	<li class="active">
																		<a class="d-flex" data-toggle="tab" href="#tab41" aria-expanded="true">
																			<img src="{{URL::asset('admin_assets/images/files/file.png')}}" alt="img" class="w-7 h-7 mr-4">
																			<div class="mt-1">
														...
														<div class="tab-pane active text-center" id="tab01">
															<div class="row my-7">
																<div class="my-8 col-md-9 d-block mx-auto">
																	<img src="{{URL::asset('admin_assets/images/files/file.png')}}" alt="img" class="w-30 mb-4">
