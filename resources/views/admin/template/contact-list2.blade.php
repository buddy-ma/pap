									...
									<div class="main-content-left main-content-left-contacts">
										...
										<div class="main-contacts-list" id="mainContactList">
											...
											<div class="main-contact-item selected">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('admin_assets/images/users/12.jpg')}}" class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
													<h6>Arlena Soles</h6><span class="phone">+1-457-658-856</span>
												</div>
											</div>
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="" src="{{URL::asset('admin_assets/images/users/1.jpg')}}" class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
													<h6>Athena Manske</h6><span>+1-457-658-856</span>
												</div>
											</div>
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="" src="{{URL::asset('admin_assets/images/users/3.jpg')}}" class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="" src="{{URL::asset('admin_assets/images/users/4.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
													<h6>Bret Guadalupe</h6><span>+1-457-658-856</span>
												</div>
											</div>
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('admin_assets/images/users/5.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('admin_assets/images/users/6.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
													<h6>Chassidy Kerr</h6><span>+1-457-658-856</span>
												</div>
											</div>
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('admin_assets/images/users/7.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('admin_assets/images/users/8.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
										...
										<div class="main-contact-info-header">
											<div class="media">
												<div class="main-img-user brround">
													<img alt="" src="{{URL::asset('admin_assets/images/users/2.jpg')}}" class="w-100 h-100 brround">
