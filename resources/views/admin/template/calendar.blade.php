...
@section('css')
		...
		<link href="{{URL::asset('admin_assets/plugins/fullcalendar/fullcalendar.css')}}" rel='stylesheet' />
		<link href="{{URL::asset('admin_assets/plugins/fullcalendar/fullcalendar.print.min.css')}}" rel='stylesheet' media='print' />
@endsection
@section('page-header')
						<!--Page header-->
...
@section('js')
		...
		<script src="{{URL::asset('admin_assets/plugins/fullcalendar/moment.min.js')}}"></script>
