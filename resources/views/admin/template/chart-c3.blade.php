...
@section('css')
		...
		<link href="{{URL::asset('admin_assets/plugins/charts-c3/c3-chart.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
						<!--Page header-->
...
@section('js')
		...
		<script src="{{URL::asset('admin_assets/plugins/charts-c3/d3.v5.min.js')}}"></script>
		<script src="{{URL::asset('admin_assets/plugins/charts-c3/c3-chart.js')}}"></script>
