...
@section('css')
		...
		<link href="{{URL::asset('admin_assets/plugins/notify/css/jquery.growl.css')}}" rel="stylesheet" />
...
@section('js')
		...
		<script src="{{URL::asset('admin_assets/plugins/notify/js/rainbow.js')}}"></script>
		<script src="{{URL::asset('admin_assets/plugins/notify/js/sample.js')}}"></script>
		<script src="{{URL::asset('admin_assets/plugins/notify/js/jquery.growl.js')}}"></script>
