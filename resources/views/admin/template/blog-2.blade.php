						...
						<div class="row">
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									...
									<div class="item7-card-img px-4">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/1.jpg')}}" alt="img" class="cover-image br-7">
									</div>
									<div class="card-body">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									...
									<div class="item7-card-img px-4">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/2.jpg')}}" alt="img" class="cover-image br-7">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									...
									<div class="item7-card-img px-4">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/3.jpg')}}" alt="img" class="cover-image br-7">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									...
									<div class="item7-card-img px-4">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/4.jpg')}}" alt="img" class="cover-image br-7">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									...
									<div class="item7-card-img px-4">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/5.jpg')}}" alt="img" class="cover-image br-7">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									...
									<div class="item7-card-img px-4">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/6.jpg')}}" alt="img" class="cover-image br-7">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="{{url('/' . $page='#')}}" class="d-flex"><i class="fe fe-calendar fs-16 mr-1"></i><div class="mt-0">Jan-14-2020</div></a>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									...
									<div class="item7-card-img px-4">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/7.jpg')}}" alt="img" class="cover-image br-7">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
											<a href="{{url('/' . $page='#')}}" class="d-flex"><i class="fe fe-calendar fs-16 mr-1"></i><div class="mt-0">Jan-14-2020</div></a>
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									...
									<div class="item7-card-img px-4">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('admin_assets/images/photos/8.jpg')}}" alt="img" class="cover-image br-7">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
							...
							<div class="col-xl-4 col-lg-6 col-md-12">
								<div class="card overflow-hidden">
									...
									<div class="item7-card-img px-4">
										<a href="#"></a>
										<img src="{{URL::asset('admin_assets/images/photos/9.jpg')}}" alt="img" class="cover-image br-7">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-flex mb-5">
