...
@section('css')
		...
		<link href="{{URL::asset('admin_assets/plugins/cookies/accept-cookies.css')}}" rel="stylesheet" />
		<link href="{{URL::asset('admin_assets/plugins/cookies/cookies.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
						<!--Page header-->
...
@section('js')
		<!-- INTERNAL Cookies js-->
		<script src="{{URL::asset('admin_assets/plugins/cookies/cookiepopup.js')}}"></script>
		<script src="{{URL::asset('admin_assets/js/cookie.js')}}"></script>
@endsection
