						...
						<div class="row">
							...
							<div class="col-md-12 col-xl-6">
								<div class="card card-aside">
									...
									<a href="#" class="card-aside-column br-tr-7 br-br-7 w-50" style="background-image: url({{URL::asset('admin_assets/images/photos/2.jpg')}})"></a>
								</div>
							</div>
							<div class="col-md-12 col-xl-6">
								<div class="card card-aside bg-primary">
									...
									<a href="#" class="card-aside-column br-tr-7 br-br-7 w-50" style="background-image: url({{URL::asset('admin_assets/images/photos/20.jpg')}})"></a>
								</div>
							</div>
							<div class="col-md-12 col-lg-6">
								<div class="card ">
									...
									<div class="card-body text-center">
										<img src="{{URL::asset('admin_assets/images/users/16.jpg')}}" class="avatar avatar-xxl brround" alt="">
							...
							<div class="col-md-12 col-lg-6">
								<div class="card ">
									...
									<div class="card-body text-center">
										<img src="{{URL::asset('admin_assets/images/users/10.jpg')}}" class="avatar avatar-xxl brround" alt="">
