                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            ...
                                            <img src="{{ asset('assets/images/blog/b-11.jpg') }}" alt="home-1"
                            ...
                            <div class="project-single" data-aos="fade-up" data-aos-delay="250">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt sale">For Sale</div>
                                            <img src="{{ asset('assets/images/blog/b-12.jpg') }}" alt="home-1"
                                                class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                            ...
                            <div class="project-single" data-aos="fade-up" data-aos-delay="350">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt sale">For Sale</div>
                                            <img src="{{ asset('assets/images/blog/b-1.jpg') }}" alt="home-1"
                                                class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt featured">Featured</div>
                                            <div class="homes-tag button alt sale">For Sale</div>
                                            <img src="{{ asset('assets/images/feature-properties/fp-10.jpg') }}"
                            ...
                            <div class="project-single no-mb" data-aos="fade-up" data-aos-delay="550">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt sale">For Sale</div>
                                            <img src="{{ asset('assets/images/feature-properties/fp-11.jpg') }}"
                                                alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                            ...
                            <div class="project-single no-mb last" data-aos="fade-up">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt sale">For Sale</div>
                                            <img src="{{ asset('assets/images/feature-properties/fp-12.jpg') }}"
                                                alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                ...
                <article class="col-lg-4 col-md-6 col-xs-12 serv" data-aos="zoom-in" data-aos-delay="150">
                    <div class="serv-flex">
                        <div class="art-1 img-13">
                            <img src="{{ asset('assets/images/icons/icon-12.svg') }}" alt="">
                ...
                <article class="col-lg-4 col-md-6 col-xs-12 serv" data-aos="zoom-in" data-aos-delay="250">
                    <div class="serv-flex">
                        <div class="art-1 img-14">
                            <img src="{{ asset('assets/images/icons/icon-13.svg') }}" alt="">
                ...
                <article class="col-lg-4 col-md-6 col-xs-12 serv mb-0 pt" data-aos="zoom-in" data-aos-delay="350">
                    <div class="serv-flex arrow">
                        <div class="art-1 img-15">
                            <img src="{{ asset('assets/images/icons/icon-14.svg') }}" alt="">
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            ...
                                            <img src="{{ asset('assets/images/blog/b-5.jpg') }}" alt="home-1"
                                                class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                            ...
                            <div class="project-single" data-aos="fade-up" data-aos-delay="250">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            <div class="homes-tag button sale rent">For Rent</div>
                                            <img src="{{ asset('assets/images/blog/b-6.jpg') }}" alt="home-1"
                                                class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                            ...
                            <div class="project-single" data-aos="fade-up" data-aos-delay="350">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            <div class="homes-tag button sale rent">For Rent</div>
                                            <img src="{{ asset('assets/images/blog/b-7.jpg') }}" alt="home-1"
                                                class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt featured">Featured</div>
                                            <div class="homes-tag button sale rent">For Rent</div>
                                            <img src="{{ asset('assets/images/feature-properties/fp-8.jpg') }}"
                                                alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 col-xl-4" data-aos="zoom-in" data-aos-delay="150">
                    ...
                    <a href="properties-map.html" class="img-box hover-effect">
                        <img src="{{ asset('assets/images/popular-places/12.jpg') }}" class="img-responsive"
                            alt="">
                        <!-- Badge -->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4" data-aos="zoom-in" data-aos-delay="250">
                    <!-- Image Box -->
                    <a href="properties-map.html" class="img-box hover-effect">
                        <img src="{{ asset('assets/images/popular-places/13.jpg') }}" class="img-responsive"
                            alt="">
                        <div class="img-box-content visible">
                            <h4>Los Angeles</h4>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4" data-aos="zoom-in" data-aos-delay="350">
                    <!-- Image Box -->
                    <a href="properties-map.html" class="img-box hover-effect">
                        <img src="{{ asset('assets/images/popular-places/14.jpg') }}" class="img-responsive"
                            alt="">
                        <div class="img-box-content visible">
                            <h4>San Francisco </h4>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4" data-aos="zoom-in" data-aos-delay="150">
                    <!-- Image Box -->
                    <a href="properties-map.html" class="img-box hover-effect">
                        <img src="{{ asset('assets/images/popular-places/15.jpg') }}" class="img-responsive"
                            alt="">
                        <div class="img-box-content visible">
                            <h4>Miami </h4>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4" data-aos="zoom-in" data-aos-delay="250">
                    ...
                    <a href="properties-map.html" class="img-box hover-effect no-mb">
                        <img src="{{ asset('assets/images/popular-places/10.jpg') }}" class="img-responsive"
                            alt="">
                        <div class="img-box-content visible">
                            <h4>Chicago</h4>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4" data-aos="zoom-in" data-aos-delay="350">
                    ...
                    <a href="properties-map.html" class="img-box hover-effect no-mb x3">
                        <img src="{{ asset('assets/images/popular-places/5.jpg') }}" class="img-responsive"
                            alt="">
                        <!-- Badge -->
                        <div class="listing-badges">
                            <span class="featured">Featured</span>
        ...
        <div class="container">
            ...
            <div class="owl-carousel job_clientSlide">
                <div class="singleJobClinet" data-aos="fade-right">
                    ...
                    <div class="detailJC">
                        <span><img src="{{ asset('assets/images/testimonials/ts-1.jpg') }}" alt="" /></span>
                        <h5>Lisa Smith</h5>
                        <p>New York</p>
                    </div>
                </div>
                <div class="singleJobClinet" data-aos="fade-left">
                    ...
                    <div class="detailJC">
                        <span><img src="{{ asset('assets/images/testimonials/ts-2.jpg') }}" alt="" /></span>
                        <h5>Jhon Morris</h5>
                        <p>Los Angeles</p>
                    </div>
                </div>
                <div class="singleJobClinet">
                    ...
                    <div class="detailJC">
                        <span><img src="{{ asset('assets/images/testimonials/ts-3.jpg') }}" alt="" /></span>
                        <h5>Mary Deshaw</h5>
                        <p>Chicago</p>
                    </div>
                </div>
                <div class="singleJobClinet">
                    ...
                    <div class="detailJC">
                        <span><img src="{{ asset('assets/images/testimonials/ts-4.jpg') }}" alt="" /></span>
                        <h5>Gary Steven</h5>
                        <p>Philadelphia</p>
                    </div>
                </div>
                <div class="singleJobClinet">
                    ...
                    <div class="detailJC">
                        <span><img src="{{ asset('assets/images/testimonials/ts-5.jpg') }}" alt="" /></span>
                        <h5>Cristy Mayer</h5>
                        <p>San Francisco</p>
                    </div>
                </div>
                <div class="singleJobClinet">
                    ...
                    <div class="detailJC">
                        <span><img src="{{ asset('assets/images/testimonials/ts-6.jpg') }}" alt="" /></span>
                        <h5>Ichiro Tasaka</h5>
                        <p>Houston</p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 col-xs-12">
                        <div class="news-item" data-aos="fade-up" data-aos-delay="300">
                            <a href="blog-details.html" class="news-img-link">
                                <div class="news-item-img">
                                    <img class="img-responsive" src="{{ asset('assets/images/blog/b-11.jpg') }}"
                                        alt="blog image">
                                </div>
                            </a>
                            <div class="news-item-text">
                    ...
                    <div class="col-xl-4 col-md-6 col-xs-12">
                        <div class="news-item no-mb" data-aos="fade-up" data-aos-delay="400">
                            <a href="blog-details.html" class="news-img-link">
                                <div class="news-item-img">
                                    <img class="img-responsive" src="{{ asset('assets/images/blog/b-12.jpg') }}"
                                        alt="blog image">
                                </div>
                            </a>
                            <div class="news-item-text">
    ...
    <div class="partners bg-white">
        <div class="container">
            ...
            <div class="owl-carousel style2">
                <div class="owl-item" data-aos="fade-up"><img src="{{ asset('assets/images/partners/11.jpg') }}"
                        alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="{{ asset('assets/images/partners/12.jpg') }}"
                        alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="{{ asset('assets/images/partners/13.jpg') }}"
                        alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="{{ asset('assets/images/partners/14.jpg') }}"
                        alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="{{ asset('assets/images/partners/15.jpg') }}"
                        alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="{{ asset('assets/images/partners/16.jpg') }}"
                        alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="{{ asset('assets/images/partners/17.jpg') }}"
                        alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="{{ asset('assets/images/partners/11.jpg') }}"
                        alt=""></div>
                <div class="owl-item" data-aos="fade-up"><img src="{{ asset('assets/images/partners/12.jpg') }}"
