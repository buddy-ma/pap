...
<!-- section start -->
<section class="portfolio-creative portfolio-section  creative2 p-0">
    <div class="container-fluid">
        <div class="row">
            @forelse ($design->sections as $section)
                <div class="col-lg-3 col-md-6 p-0 isotopeSelector">
                    <img alt="" class="img-fluid" src="{{URL::asset('storage/design/sections/'.$section->image)}}">
                </div>
                <div class="col-lg-3 col-md-6  p-0 h-100 my-auto">
                    <div class="portfolio-text m-auto text-center">
                        <h2 class="head-text"> {{$section->title}} </h2>
                        <p class="head-sub-text">
                            {{$section->description}}
                        </p>
                        <a class="btn btn-default primary-btn radius-0" href="#">{{ $section->button }}</a>
                    </div>
                </div>
            @empty
                <p> Empty Results </p>
